...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'Einfachsatz']) &lt;= 1">extension with URL = 'Einfachsatz': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'Punktzahl']) &lt;= 1">extension with URL = 'Punktzahl': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'Faktor']) &lt;= 1">extension with URL = 'Faktor': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'FaktorGrund']) &lt;= 1">extension with URL = 'FaktorGrund': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'MinderungP6GOAE']) &lt;= 1">extension with URL = 'MinderungP6GOAE': maximum cardinality of 'extension' is 1</sch:assert>
