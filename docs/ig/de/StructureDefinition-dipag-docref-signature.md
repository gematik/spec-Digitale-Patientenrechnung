# Digitale Patientenrechnung DocRef Signature - Implementierungsleitfaden Digitale Patientenrechnung v1.1.0
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://gematik.de/fhir/dipag/StructureDefinition/dipag-docref-signature | *Version*:1.1.0 |
