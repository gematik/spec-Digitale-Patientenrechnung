# Digitale Patientenrechnung Rechnungsstatus - Implementierungsleitfaden Digitale Patientenrechnung v1.1.0
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://gematik.de/fhir/dipag/ValueSet/dipag-rechnungsstatus-vs | *Version*:1.1.0 |
| Active Stand: 2026-03-26 | *Maschinenlesbarer Name*:DiPagRechnungsstatusVS |

 
ValueSet für den Bearbeitungsstatus eines Rechnungsdokuments (offen, erledigt, papierkorb) 
