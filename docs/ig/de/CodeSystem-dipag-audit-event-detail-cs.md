# Digitale Patientenrechnung Audit Event Detail - Implementierungsleitfaden Digitale Patientenrechnung v1.1.0
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://gematik.de/fhir/dipag/CodeSystem/dipag-audit-event-detail-cs | *Version*:1.1.0 |
