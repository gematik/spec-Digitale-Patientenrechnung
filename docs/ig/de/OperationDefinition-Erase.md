# Digitale Patientenrechnung Operation Erase - Implementierungsleitfaden Digitale Patientenrechnung v1.1.0
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://gematik.de/fhir/dipag/OperationDefinition/Erase | *Version*:1.1.0 |
