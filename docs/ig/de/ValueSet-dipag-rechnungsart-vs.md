# Digitale Patientenrechnung Rechnungsart VS - Implementierungsleitfaden Digitale Patientenrechnung v1.0.8
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://gematik.de/fhir/dipag/ValueSet/dipag-rechnungsart-vs | *Version*:1.0.8 |
