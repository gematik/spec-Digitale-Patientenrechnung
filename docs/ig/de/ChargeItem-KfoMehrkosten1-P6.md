# KfoMehrkosten1 Rechnungsposition 6 – GOZ 6150 Bogen (20.08.24) - Implementierungsleitfaden Digitale Patientenrechnung v1.1.0
...
* **KfoMehrkosten1 Rechnungsposition 6 – GOZ 6150 Bogen (20.08.24)**

## Beispiel ChargeItem: KfoMehrkosten1 Rechnungsposition 6 – GOZ 6150 Bogen (20.08.24)
...
**reason**: superrealistische, thermoaktive Bögen bei selbstligierten Brackets
...
```json
{
  ...
  "reason" : [{
    "text" : "superrealistische, thermoaktive Bögen bei selbstligierten Brackets"
  }]
}
