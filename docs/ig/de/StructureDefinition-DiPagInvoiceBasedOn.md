# Digitale Patientenrechnung BasedOn Extension - Implementierungsleitfaden Digitale Patientenrechnung v1.1.0
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://gematik.de/fhir/dipag/StructureDefinition/DiPagInvoiceBasedOn | *Version*:1.1.0 |
