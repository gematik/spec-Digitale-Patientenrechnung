# Digitale Patientenrechnung Audit Event Sub-Type - Implementierungsleitfaden Digitale Patientenrechnung v1.0.8
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://gematik.de/fhir/dipag/ValueSet/dipag-audit-event-sub-type-vs | *Version*:1.0.8 |
