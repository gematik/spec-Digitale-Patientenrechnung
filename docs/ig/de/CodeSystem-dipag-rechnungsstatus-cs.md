# Digitale Patientenrechnung Rechnungsstatus CS - Implementierungsleitfaden Digitale Patientenrechnung v1.1.0
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://gematik.de/fhir/dipag/CodeSystem/dipag-rechnungsstatus-cs | *Version*:1.1.0 |
