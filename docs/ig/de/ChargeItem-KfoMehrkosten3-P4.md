# KfoMehrkosten3 Rechnungsposition 4 – BEMA 120d Einstellung B/B besonders schwierig (29.07.24) - Implementierungsleitfaden Digitale Patientenrechnung v1.0.8
...
* **KfoMehrkosten3 Rechnungsposition 4 – BEMA 120d Einstellung B/B besonders schwierig (29.07.24)**

## Beispiel ChargeItem: KfoMehrkosten3 Rechnungsposition 4 – BEMA 120d Einstellung B/B besonders schwierig (29.07.24)
...
**code**: Maßnahmen zur Einstellung des Unterkiefers in den Regelbiss in sagittaler oder lateraler Richtung einschließlich Retention - besonders schwierig durchführbarer Art
...
```json
{
  ...
  "code" : {
    "coding" : [{
      ...
      "code" : "120d",
      "display" : "Maßnahmen zur Einstellung des Unterkiefers in den Regelbiss in sagittaler oder lateraler Richtung einschließlich Retention - besonders schwierig durchführbarer Art"
    }]
  },
  "subject" : {
