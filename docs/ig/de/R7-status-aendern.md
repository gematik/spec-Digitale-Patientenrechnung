# R7: Manuelles Aendern des Bearbeitungsstatus von Rechnungen - Implementierungsleitfaden Digitale Patientenrechnung v1.1.0
...
* **R7: Manuelles Aendern des Bearbeitungsstatus von Rechnungen**
...
Siehe [OperationDefinition $change-status](OperationDefinition-DiPagOperationChangeStatus.md).
...
[Parameters-BeispielParameterChangeStatusInput](Parameters-BeispielParameterChangeStatusInput.md)
...
[Parameters-BeispielParameterChangeStatusOutput](Parameters-BeispielParameterChangeStatusOutput.md)
...
[Bundle-BulkChangeStatusExampleInput](Bundle-BulkChangeStatusExampleInput.md)
...
[Bundle-BulkChangeStatusExampleOutput](Bundle-BulkChangeStatusExampleOutput.md)
