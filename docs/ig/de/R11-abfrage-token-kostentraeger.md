# R11: Abfrage von Daten zu Rechnungen und Dokumenten per Token (Kostentraeger) - Implementierungsleitfaden Digitale Patientenrechnung v1.0.8
...
* **R11: Abfrage von Daten zu Rechnungen und Dokumenten per Token (Kostentraeger)**
