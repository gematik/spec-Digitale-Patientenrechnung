# Digitale Patientenrechnung Task RequestedPerformer - Implementierungsleitfaden Digitale Patientenrechnung v1.1.0
...
* **Digitale Patientenrechnung Task RequestedPerformer**

## Extension: Digitale Patientenrechnung Task RequestedPerformer 

| | |
| :--- | :--- |
| *Offizielle URL*:http://hl7.org/fhir/5.0/StructureDefinition/extension-Task.requestedPerformer | *Version*:1.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.gematik.dipag|current/StructureDefinition/StructureDefinition-dipag-task-requestedPerformer.json)
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-dipag-task-requestedPerformer.csv), [Excel](../StructureDefinition-dipag-task-requestedPerformer.xlsx), [Schematron](../StructureDefinition-dipag-task-requestedPerformer.sch) 
...
```json
{
  ...
  "version" : "1.1.0",
  "name" : "DiPagTaskRequestedPerformer",
