# BeispielNutzungsprotokollProcessFlag - Implementierungsleitfaden Digitale Patientenrechnung v1.1.0
...
* **BeispielNutzungsprotokollProcessFlag**

## Beispiel AuditEvent: BeispielNutzungsprotokollProcessFlag
...
**recorded**: 2024-06-01 10:00:00+0000
...
| :--- | :--- | :--- |
| - | **Type** | **Value[x]** |
| * | DocumentReference.meta.extension:markierung | Markierung 'Persönlich' gesetzt |
