# BeispielNutzungsprotokoll - Implementierungsleitfaden Digitale Patientenrechnung v1.1.0
...
* **BeispielNutzungsprotokoll**

## Beispiel AuditEvent: BeispielNutzungsprotokoll
...
**subtype**: [Digitale Patientenrechnung Operationen: invoice-submit](CodeSystem-dipag-operationen-cs.md#dipag-operationen-cs-invoice-submit) (Digitale Patientenrechnung_Submit)

**action**: Execute

**recorded**: 2024-05-29 11:25:54+0002
...
| :--- | :--- | :--- | :--- |
| - | **Type** | **Who** | **Requestor** |
| * | Human User | Beispiel Leistungsempfänmger (Identifier: Provider number/11223344) | true |
...
| :--- | :--- |
| - | **Observer** |
| * | FD (Identifier:[Uniform Resource Identifier (URI)](http://terminology.hl7.org/7.3.0/NamingSystem-uri.html)/urn:oid:1.2.276.0.76.4.323) |
...
| :--- | :--- | :--- |
| - | **Type** | **Value[x]** |
| * | Allgemein | Rechnung eingereicht |
