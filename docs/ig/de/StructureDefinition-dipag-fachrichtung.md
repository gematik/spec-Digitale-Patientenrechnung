# Digitale Patientenrechnung Extension Fachrichtung - Implementierungsleitfaden Digitale Patientenrechnung v1.0.8
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://gematik.de/fhir/dipag/StructureDefinition/dipag-fachrichtung | *Version*:1.0.8 |
