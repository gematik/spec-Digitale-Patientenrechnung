# Digitale Patientenrechnung Zahlungsziel - Implementierungsleitfaden Digitale Patientenrechnung v1.1.0
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://gematik.de/fhir/dipag/StructureDefinition/dipag-zahlungsziel | *Version*:1.1.0 |
