# KfoMehrkosten2 Rechnungsposition 6 – GOZ 2110A Minibracket (24.09.25) - Implementierungsleitfaden Digitale Patientenrechnung v1.0.8
...
* **KfoMehrkosten2 Rechnungsposition 6 – GOZ 2110A Minibracket (24.09.25)**

## Beispiel ChargeItem: KfoMehrkosten2 Rechnungsposition 6 – GOZ 2110A Minibracket (24.09.25)
...
**reason**: Incl. Materialkosten Damonbracket
...
```json
{
  ...
  "reason" : [{
    "text" : "Incl. Materialkosten Damonbracket"
  }]
}
