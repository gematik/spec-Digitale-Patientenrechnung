# KfoMehrkosten3 Rechnungsposition 11 – Labor 732-0 Labialbogen intermaxillar (16.09.24) - Implementierungsleitfaden Digitale Patientenrechnung v1.1.0
...
* **KfoMehrkosten3 Rechnungsposition 11 – Labor 732-0 Labialbogen intermaxillar (16.09.24)**

## Beispiel ChargeItem: KfoMehrkosten3 Rechnungsposition 11 – Labor 732-0 Labialbogen intermaxillar (16.09.24)
...
**code**: 732-0 - Labialbogen intermaxillar
...
```json
{
  ...
  "status" : "billable",
  "code" : {
    "text" : "732-0 - Labialbogen intermaxillar"
  },
  "subject" : {
