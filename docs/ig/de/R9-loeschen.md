# R9: Loeschen eines Rechnungsvorganges - Implementierungsleitfaden Digitale Patientenrechnung v1.0.8
...
* **R9: Loeschen eines Rechnungsvorganges**
...
Siehe [OperationDefinition $erase](OperationDefinition-DiPagOperationErase.md).
