# KfoMehrkosten3 Rechnungsposition 9 – Labor 702-0 Basis bi/maxillares Gerät (16.09.24) - Implementierungsleitfaden Digitale Patientenrechnung v1.1.0
...
* **KfoMehrkosten3 Rechnungsposition 9 – Labor 702-0 Basis bi/maxillares Gerät (16.09.24)**

## Beispiel ChargeItem: KfoMehrkosten3 Rechnungsposition 9 – Labor 702-0 Basis bi/maxillares Gerät (16.09.24)
...
**code**: 702-0 - Basis bi/maxillares Gerät
...
```json
{
  ...
  "status" : "billable",
  "code" : {
    "text" : "702-0 - Basis bi/maxillares Gerät"
  },
  "subject" : {
