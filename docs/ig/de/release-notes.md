# Release Notes - Implementierungsleitfaden Digitale Patientenrechnung v1.1.0
...
* Szenariobeschreibung ([R1: Rechnung mit Dokumenten validieren und versenden](R1-rechnung-versenden.md)) um den Abschnitt "Position des Datamatrix-Codes" ergänzt sowie alle Submit-Eingabebeispiele (R1 und R2-Bulk) an die neue Parameterstruktur angepasst.
 

#### Redaktionelle Änderungen

* **Löschen eines Rechnungsvorganges ([R9: Löschen eines Rechnungsvorganges](R9-loeschen.md))**: Die Interaktion ist nicht länger dem Use Case AF_10245 zugeordnet (dieser umfasst ausschließlich das manuelle Ändern des Bearbeitungsstatus); der Verweis auf "Tabelle 27: Use Case Automatisches endgültiges Löschen von Rechnungen" des Feature-Dokumentes wurde entfernt.
* Doppelten Eintrag zum Use Case AF_10262 auf der Seite "[Akteure und Interaktionen](akteure-und-interaktionen.md)" entfernt und Schreibfehler ("Kostentraäger") in [Use Cases](use-cases.md) korrigiert.
...
* Vollständige Überarbeitung der Beschreibungen für [R2: Rechnung einreichen (Bulk)](R2-rechnung-einreichen-bulk.md) (R2-Rechnung-validieren-einreichen-Bulk) 
...
* Überarbeitung der Beschreibungen für [R4: PDF/A-Abruf (Rechnungsersteller, Bulk)](R4-pdf-abruf-rechnungsersteller-bulk.md) (R4-Abfrage-von-angereicherten-PDF-A-per-Token-Rechnungsersteller-Bulk) 
