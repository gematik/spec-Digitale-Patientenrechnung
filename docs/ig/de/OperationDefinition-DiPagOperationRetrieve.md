# Digitale Patientenrechnung Operation Retrieve - Implementierungsleitfaden Digitale Patientenrechnung v1.0.8
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://gematik.de/fhir/dipag/OperationDefinition/Retrieve | *Version*:1.0.8 |
