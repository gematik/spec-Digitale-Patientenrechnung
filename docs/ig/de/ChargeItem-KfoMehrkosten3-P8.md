# KfoMehrkosten3 Rechnungsposition 8 – Labor 020-2 Basis für Konstruktionsbiss (16.09.24) - Implementierungsleitfaden Digitale Patientenrechnung v1.0.8
...
* **KfoMehrkosten3 Rechnungsposition 8 – Labor 020-2 Basis für Konstruktionsbiss (16.09.24)**

## Beispiel ChargeItem: KfoMehrkosten3 Rechnungsposition 8 – Labor 020-2 Basis für Konstruktionsbiss (16.09.24)
...
**code**: 020-2 - Basis für Konstruktionsbiss
...
```json
{
  ...
  "status" : "billable",
  "code" : {
    "text" : "020-2 - Basis für Konstruktionsbiss"
  },
  "subject" : {
