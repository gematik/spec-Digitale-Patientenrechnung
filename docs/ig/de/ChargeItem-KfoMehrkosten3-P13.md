# KfoMehrkosten3 Rechnungsposition 13 – Labor 740-0 Verbindungselemente/inframaxillar (16.09.24) - Implementierungsleitfaden Digitale Patientenrechnung v1.0.8
...
* **KfoMehrkosten3 Rechnungsposition 13 – Labor 740-0 Verbindungselemente/inframaxillar (16.09.24)**

## Beispiel ChargeItem: KfoMehrkosten3 Rechnungsposition 13 – Labor 740-0 Verbindungselemente/inframaxillar (16.09.24)
...
**code**: 740-0 - Verbindungselemente/inframaxillar
...
```json
{
  ...
  "status" : "billable",
  "code" : {
    "text" : "740-0 - Verbindungselemente/inframaxillar"
  },
  "subject" : {
