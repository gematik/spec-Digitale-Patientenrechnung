# Digitale PatientenrechnungVerkehrsmittel - Implementierungsleitfaden Digitale Patientenrechnung v1.0.8
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://gematik.de/fhir/dipag/ValueSet/DiPagVerkehrsmittel | *Version*:1.0.8 |
