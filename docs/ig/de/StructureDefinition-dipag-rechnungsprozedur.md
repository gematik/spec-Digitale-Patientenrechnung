# Digitale Patientenrechnung Rechnungsprozedur - Implementierungsleitfaden Digitale Patientenrechnung v1.1.0
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://gematik.de/fhir/dipag/StructureDefinition/dipag-rechnungsprozedur | *Version*:1.1.0 |
