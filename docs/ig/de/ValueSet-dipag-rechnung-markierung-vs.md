# Digitale Patientenrechnung Rechnung Markierung VS - Implementierungsleitfaden Digitale Patientenrechnung v1.0.8
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://gematik.de/fhir/dipag/ValueSet/dipag-rechnung-markierung-vs | *Version*:1.0.8 |
