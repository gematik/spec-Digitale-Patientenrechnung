# R6: Abfrage von Daten zu Rechnungen und Dokumenten per Token (Rechnungsempfaenger) - Implementierungsleitfaden Digitale Patientenrechnung v1.1.0
...
* **R6: Abfrage von Daten zu Rechnungen und Dokumenten per Token (Rechnungsempfaenger)**
...
Siehe [OperationDefinition $retrieve](OperationDefinition-DiPagOperationRetrieve.md).
...
[Parameters-BeispielParameterRetrieveInput](Parameters-BeispielParameterRetrieveInput.md)
...
[Parameters-BeispielParameterRetrieveOutput](Parameters-BeispielParameterRetrieveOutput.md)
