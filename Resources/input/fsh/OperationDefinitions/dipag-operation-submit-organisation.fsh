...
* parameter[+]
  ...
  * min = 1
  * max = "1"
  * documentation = "Der für diese Einreichung gewählte Workflowtyp aus den Workflowtypen der Einrichtungsadressierung. Es MUSS ein Workflowtyp gewählt werden, der von der Ziel-Organisation unterstützt wird; Einreichungen mit einem nicht unterstützten Workflowtyp lehnt der FD ab. Der FD setzt den gewählten Workflowtyp als meta.tag an der internen DocumentReference."
  * type = #code
  * binding
    * strength = #required
