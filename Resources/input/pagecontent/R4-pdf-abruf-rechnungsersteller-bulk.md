...
Für die Ausführung der Operation gelten die gleichen Vorgaben wie aus [R1: Rechnung versenden](R1-rechnung-versenden.html). Die Operation `$retrieve` kann für innerhalb eines Batch-Bundles mehrfach, auch für unterschiedliche Dokumente aufgerufen werden. Es gelten die entsprechenden Vorgaben aus der [FHIR-Kernspezifikation](https://www.hl7.org/fhir/r4/http.html#transaction).
...
[Bundle-BulkRetrieveExampleInput](Bundle-BulkRetrieveExampleInput.html)
...
[Bundle-BulkRetrieveExampleOutput](Bundle-BulkRetrieveExampleOutput.html)
